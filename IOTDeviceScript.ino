...
const char ssid[] = "Nancy G"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "Tagamandapio64@"; // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "18.207.225.255"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
...
void displayMessage(String message) {
  ...
  if (message.equals("OK")) {
    ...
    /*display.println("");
    display.println("");*/
    if (message.indexOf("ALERT2") >= 0) {
      display.println(" Inestable");
    }else {
      message = "ALERT!";
      display.println("  " + message);
    }
